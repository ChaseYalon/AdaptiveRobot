...
from actions.drivetrain_sysid import RightDrivetrainSysIDRoutine
...
class MyRobot(AdaptiveRobot):
    ...
    def onAutonomousInit(self) -> None:
        routine = RightDrivetrainSysIDRoutine(self.drivetrain, self.drivetrain_io)
        self.schedule_action(routine.full_test(), "Drivetrain Sysid")
